        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
              <li><a class="dropdown-item" href="pain-managment.html">Pain Management</a></li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link text-white" href="blog-list.html">Blog</a>
          </li>
          <li class="nav-item">
            <a class="btn btn-outline-primary text-white btn-appointment nav-link px-3" href="tel:9140012929">Book Appointment</a>
          </li>
        </ul>
      </div>
    </div>
